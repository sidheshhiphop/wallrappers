...
function ContactUs() {
  return (
    <div class="h-full p-2 lg:p-20 ">
        <section class=" text-gray-800">
    
    <div class="block rounded-lg shadow-lg bg-white">
      <div class="flex flex-wrap items-center">
        <div class="grow-0 shrink-0 basis-auto block w-full lg:flex lg:w-6/12 xl:w-4/12">
          <div style={{height:"500px"}} class="map-container-2 w-full">
            <iframe src="https://maps.google.com/maps?q=Jedarpalayam&t=&z=13&ie=UTF8&iwloc=&output=embed" class="left-0 top-0 h-full w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg" frameborder="0" allowfullscreen></iframe>
          </div>
        </div>
...
<a href="mailto:wallrappers44@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M0 3v18h24v-18h-24zm6.623 7.929l-4.623 5.712v-9.458l4.623 3.746zm-4.141-5.929h19.035l-9.517 7.713-9.518-7.713zm5.694 7.188l3.824 3.099 3.83-3.104 5.612 6.817h-18.779l5.513-6.812zm9.208-1.264l4.616-3.741v9.348l-4.616-5.607z"/></svg></a>                  </div>
                </div>
                <div class="grow ml-6">
                  <a href="mailto:wallrappers44@gmail.com">
                  <p class="font-bold mb-1">Email</p>
                  <p class="text-gray-500">wallrappers44@gmail.com</p>
