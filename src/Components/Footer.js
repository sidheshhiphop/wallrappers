...
<footer class="text-center text-white" style={{backgroundColor: "#f1f1f1"}}>
  <div class="container pt-9">
    <div class="flex justify-center mb-9">
      ...
      <a href="https://wallrappers.netlify.app/" class="mr-9 text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://www.instagram.com/wall_rappers/?hl=en" target="_blank" class="mr-9 text-gray-800">
        <svg
          aria-hidden="true"
          focusable="false"
          data-prefix="fab"
      ...
      <a href="https://www.youtube.com/@wallrappers1114/videos" target="_blank" class="text-gray-800">
